proc create_ipi_design { offsetfile design_name } {
	...
	set pushbutton_0 [ create_bd_cell -type ip -vlnv user:user:pushbutton:1.0 pushbutton_0]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user:user:pushbutton:1.0]]]]
